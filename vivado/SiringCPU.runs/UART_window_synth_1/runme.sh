...
HD_PWD='C:/CodingProjects/RTLProject/LTS-SiringCPU/vivado/SiringCPU.runs/UART_window_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_window.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UART_window.tcl
