...
assign o01_ISU_IDU_ready = ~((GPR_lock[i05_IDU_GPR_rj] & i05_IDU_GPR_rj!=5'b0)|(GPR_lock[i05_IDU_GPR_rk] & i05_IDU_GPR_rk!=5'b0)|(GPR_lock[i05_IDU_GPR_rd] & i05_IDU_GPR_rd!=5'b0)) ;//如果访问到被锁存的内容，则返回"没准备好"
`endif
integer i;
