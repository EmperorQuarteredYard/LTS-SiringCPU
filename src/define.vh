...
// `define RAM_BEHAVIOR_ASYN // 在需要同步RAM时，开启此选项
`define RAM_BEHAVIOR_SYNC // 在需要异步RAM时，开启此选项。注意和上面的一起开启或者都不开会报错
...
//========================缺省值==============================
`define RST_PC          32'h1bfffffc//实际上应该是1c000000，这里省去了一拍的进位(应当需要根据实际情况判断)
